...
#tiff(filename = "~/Desktop//03_Lotus_annotation/TranscriptLengthDist.tiff")
...
hist(d[which(d[,7]<500),7],breaks=100,col=c("red"), xlab=" Non-normalized 5' distances", ylab='Insertion counts', main='Exonic LORE1 Insertion ditribution')


#tiff(filename = "~/Desktop//03_Lotus_annotation/Lore1_normalized_distribution.tiff")
hist(d[,7]/d[,8],breaks=100, col=c("green"), xlab=" Normalized 5' distances", ylab='Insertion counts', main='Exonic LORE1 Insertion ditribution')
